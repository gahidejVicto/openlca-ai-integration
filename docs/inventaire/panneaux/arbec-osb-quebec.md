...
|---|---|---|---|---|
| Matériau | OSB | Produit | ✅ Confirmé | S1, S2 |
| Usine | Shawinigan et Amos, Québec | Usine | ✅ Sites OSB confirmés | S1 |
| Entreprise | Arbec, Bois d’œuvre inc. | Entreprise | ✅ Confirmé | S1 |
| Groupe | Groupe Rémabec | Groupe | ✅ Confirmé | S1 |
| Rôle | Fabrication d’OSB | Usine | ✅ Confirmé | S1 |
...
|---|---|---|---|---|
| Nature | Panneaux structuraux OSB | Produit | ✅ Gamme générale | S2 |
| Produit réellement fabriqué sur le site | Non trouvé dans les sources publiques consultées au niveau d’une référence précise | Produit/usine | ❓ À demander | — |
| Épaisseur, classe, densité et normes du produit pilote | Non trouvé dans les sources publiques consultées | Produit | ❓ À demander | — |
| Étapes de procédé du site | Non trouvé dans les sources publiques consultées au niveau de détail requis | Usine | ❓ À demander | — |

## 3. Matières premières principales

| Information | Donnée publique | Niveau | Statut | Source |
|---|---|---|---|---|
| Essences et géographie du bois | Non trouvé dans les sources publiques consultées pour le produit pilote | Produit/usine | ❓ À demander | — |
| Bois entrant, humidité, contenu récupéré et rendement | Non trouvé dans les sources publiques consultées | Produit/usine | ❓ À demander | — |

## 4. Résines / adhésifs

| Information | Donnée publique | Niveau | Statut | Source |
|---|---|---|---|---|
| Résine, cire et autres additifs | Non trouvé dans les sources publiques consultées pour le produit pilote | Produit/usine | ❓ À demander | — |
| Dosages et fournisseurs | Non trouvé dans les sources publiques consultées | Produit/usine | ❓ À demander | — |
| Émissions de formaldéhyde du produit | Non trouvé dans les sources publiques consultées pour le couple produit–usine | Produit/usine | ❓ À demander | — |
...
|---|---|---|---|---|
| Page d’installation | Site et activité OSB documentés | Usine | ✅ | S1 |
| Page de produit | Gamme OSB générale documentée | Produit/groupe | ✅, attribution au site à confirmer | S2 |
| DEP/EPD ou ACV propre au couple produit–usine | Non trouvé dans les sources publiques consultées | Produit/usine | ❓ À demander | — |
...
**Correspondance Ecoinvent non établie à ce stade.** Une fiche fabricant ne sélectionne ni dataset ni proxy. La correspondance finale exigera la caractérisation du dataset, la définition du produit physique, le choix d’un produit comparable, la comparaison des paramètres et une validation humaine.

| Élément | Constat provisoire |
|---|---|
| Produit et périmètre industriel | Le site est identifié comme usine OSB; aucune référence commerciale n’est attribuée automatiquement à ce site. |
...
1. Désigner le produit OSB représentatif réellement fabriqué sur chaque site retenu et documenter ses normes, dimensions, densité et volume.
2. Fournir essences, origine et quantité de bois, rendement, résines, cire et additifs par m³.
3. Fournir énergie, eau, émissions, résidus, déchets et effluents du même périmètre de production.
4. Documenter les distances d’approvisionnement et transmettre toute DEP/ACV et certification applicable.

## 13. Sources documentaires

### S1 — Installations / page d’usine
- Organisme : Arbec, Bois d’œuvre inc..
- URL : https://www.arbec.ca/fr/installations/
- Consultation : 2026-09-08.
- Information effectivement extraite : identification de Shawinigan et Amos, Québec comme installation OSB et rôle de fabrication.

### S2 — Panneaux OSB
- Organisme : Arbec.
- URL : https://www.arbec.ca/fr/produits/panneaux-osb/
- Consultation : 2026-09-08.
- Information effectivement extraite : offre générale de panneaux OSB.
