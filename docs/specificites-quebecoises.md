...
- **Matériau d'emballage blanc en rouleau :** reste sans identification aboutie — toute spécificité québécoise pour cet objet reste, par définition, à établir. Deux candidats non confirmés de natures opposées (film LDPE plat vs mousse rigide EPS, hors sujet) ont été relevés sur Ecoinvent 3.11 le 2026-09-16, sans validation physique.
